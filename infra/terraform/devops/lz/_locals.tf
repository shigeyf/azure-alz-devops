...
locals {
  ...
  #container_app_job_name              = join("-", ["cajob"], ["agents", local.location_short_name, local.rand_id])
  #container_app_job_placeholder_name  = join("-", ["cajob"], ["agents", local.location_short_name, local.rand_id], ["ph"])
